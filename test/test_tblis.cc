...
//    tblis::tensor<double> A({d1, d2});
//    tblis::tensor<double> B({d2, d3});
//    tblis::tensor<double> C({d1, d4});

////    std::vector<double> C_vec(16, 0.0);
////    MArray::varray_view<double> D({4, 4}, &C_vec.data()[0]);
////    //  std::vector<long> d5{2,3,2,3};
//    //  tblis::tensor<double> C({d1,d2});
...
//    double beta = 0.0;
//    double alpha = 1.0;
//    //  tblis::mult<double>(alpha, A, la.data(), B, lb.data(), beta, C,
//    //  lc.data());
//    //  tblis::mult<double>(alpha, A, la.data(), B, lb.data(), beta, C,
//    //  lc.data());
//    tblis::mult<double>(alpha, A, "a1,b2", B, "b2,c", beta, C, "a1,c");
////    for (auto c : C_vec)
////        std::cout << " " << c;
//}
