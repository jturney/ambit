    ...
    TestResult expected)
{
    ...
    try {
        ...
        if (delta == 0.0 && expected != kEpsilon) observed = kExact;
...
double try_1_norm()
{
    ...
    else return delta / fabs(normA1 + normA2);
}
...
double try_permute_rank1_i()
{
    ...
    if (mode == 0) C1.permute(A,{"i"},{"i"},alpha,beta);
    else if (mode == 1) C1("i") = A("i");
    else if (mode == 2) C1("i") += A("i");
...
double try_permute_rank2_ij()
{
    ...
    if (mode == 0) C1.permute(A,{"i","j"},{"i","j"},alpha,beta);
    else if (mode == 1) C1("ij") = A("ij");
    else if (mode == 2) C1("ij") += A("ij");
...
double try_permute_rank2_ji()
{
    ...
    if (mode == 0) C1.permute(A,{"i","j"},{"j","i"},alpha,beta);
    else if (mode == 1) C1("ij") = A("ji");
    else if (mode == 2) C1("ij") += A("ji");
...
double try_permute_rank3_ijk()
{
    ...
    if (mode == 0) C1.permute(A,{"i","j","k"},{"i","j","k"},alpha,beta);
    else if (mode == 1) C1("ijk") = A("ijk");
    else if (mode == 2) C1("ijk") += A("ijk");
...
double try_permute_rank3_ikj()
{
    ...
    if (mode == 0) C1.permute(A,{"i","j","k"},{"i","k","j"},alpha,beta);
    else if (mode == 1) C1("ijk") = A("ikj");
    else if (mode == 2) C1("ijk") += A("ikj");
...
double try_permute_rank3_jik()
{
    ...
    if (mode == 0) C1.permute(A,{"i","j","k"},{"j","i","k"},alpha,beta);
    else if (mode == 1) C1("ijk") = A("jik");
    else if (mode == 2) C1("ijk") += A("jik");
...
double try_permute_rank3_jki()
{
    ...
    if (mode == 0) C1.permute(A,{"i","j","k"},{"j","k","i"},alpha,beta);
    else if (mode == 1) C1("ijk") = A("jki");
    else if (mode == 2) C1("ijk") += A("jki");
...
double try_permute_rank3_kij()
{
    ...
    if (mode == 0) C1.permute(A,{"i","j","k"},{"k","i","j"},alpha,beta);
    else if (mode == 1) C1("ijk") = A("kij");
    else if (mode == 2) C1("ijk") += A("kij");
...
double try_permute_rank3_kji()
{
    ...
    if (mode == 0) C1.permute(A,{"i","j","k"},{"k","j","i"},alpha,beta);
    else if (mode == 1) C1("ijk") = A("kji");
    else if (mode == 2) C1("ijk") += A("kji");
...
double try_permute_rank4_ijkl()
{
    ...
    if (mode == 0) C1.permute(A,{"i","j","k","l"},{"i","j","k","l"},alpha,beta);
    else if (mode == 1) C1("ijkl") = A("ijkl");
    else if (mode == 2) C1("ijkl") += A("ijkl");
...
double try_permute_rank4_ijlk()
{
    ...
    if (mode == 0) C1.permute(A,{"i","j","k","l"},{"i","j","l","k"},alpha,beta);
    else if (mode == 1) C1("ijkl") = A("ijlk");
    else if (mode == 2) C1("ijkl") += A("ijlk");
...
double try_permute_rank4_jikl()
{
    ...
    if (mode == 0) C1.permute(A,{"i","j","k","l"},{"j","i","k","l"},alpha,beta);
    else if (mode == 1) C1("ijkl") = A("jikl");
...
double try_permute_rank4_ikjl()
{
    ...
    if (mode == 0) C1.permute(A,{"i","j","k","l"},{"i","k","j","l"},alpha,beta);
    else if (mode == 1) C1("ijkl") = A("ikjl");
    else if (mode == 2) C1("ijkl") += A("ikjl");
...
double try_permute_rank4_lkji()
{
    ...
    if (mode == 0) C1.permute(A,{"i","j","k","l"},{"l","k","j","i"},alpha,beta);
    else if (mode == 1) C1("ijkl") = A("lkji");
    else if (mode == 2) C1("ijkl") += A("lkji");
