...
vector<Indices> determine_contraction_result(const LabeledTensor& A, const LabeledTensor& B);
vector<Indices> determine_contraction_result_from_indices(Indices Aindices, Indices Bindices);
